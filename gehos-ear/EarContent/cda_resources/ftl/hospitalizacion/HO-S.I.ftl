...
<ClinicalDocument xmlns="urn:hl7-org" classCode="DOCCLIN" moodCode="EVN">
	...
	<templateId root="${documento.oidDocumentoClinicoCDA}" extension="HO-S.I" />
				...
				<table>
   					<tbody>   												
						<tr>
							...
							<td>
								${documento.servicioSolicitante}
							</td>
							<td>
								Ubicaci&#243;n del paciente
							</td>
							<td>
								${documento.ubicacionPaciente}
							</td>							
						</tr>	
						<tr>
							<td>
						...
						<tr>
							<td>
								<paragraph>
								    <caption>
								    	Resumen m&#233;dico del caso
								    </caption>
								   	${documento.resumenMedico}
							 	</paragraph>
							</td>							
						</tr>		
					</tbody>

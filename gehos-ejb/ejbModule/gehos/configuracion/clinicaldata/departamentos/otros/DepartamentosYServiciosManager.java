package gehos.configuracion.clinicaldata.departamentos.otros;
...
import gehos.configuracion.clinicaldata.departamentos.otros.treebuilders.DepartamentosYServiciosTreeBuilder;
...
@Name("departamentosYServiciosNoClinicosManager")
public class DepartamentosYServiciosManager {
	...
	@In(required = false, create = true, value = "departamentosYServiciosNoClinicosTreeBuilder")
	...
	public void salvarDepartamento() {
		long cid = bitacora
				.registrarInicioDeAccion("modificando departamento..");
		departamento_en_edicion = entityManager.merge(departamento_en_edicion);
		departamento_en_edicion.setCid(cid);
	...
	public void adicionarDepartamentoClinico() {
		try {
			...
			departamento_clinico.setEsClinico(false);
	...
	public List<Departamento_configuracion> departments() {
		return entityManager
				.createQuery(
						"from Departamento_configuracion dep where dep.esClinico = false order by dep.nombre")
				.getResultList();
	}

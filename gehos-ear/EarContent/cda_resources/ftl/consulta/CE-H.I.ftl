...
<ClinicalDocument xmlns="urn:hl7-org" classCode="DOCCLIN" moodCode="EVN">
	...
	<templateId root="${documento.oidDocumentoClinicoCDA}" extension="HO-H.I" />
 ...
 <component>
   <structuredBody>  
        ...
        <component>
    		<section>        		
    		   <title>Informaci&#243;n de la atenci&#243;n al paciente</title>
    		   <text>
    		   		<#if documento.descHallazgos??>
	    		   		<paragraph>
						    <caption>
						    	Descripci&#243;n de los hallazgos
						    </caption>
						   	${documento.descHallazgos}
			 			</paragraph>
			 		</#if>		 			

...
<ClinicalDocument xmlns="urn:hl7-org" classCode="DOCCLIN" moodCode="EVN">
	...
	<templateId root="${documento.oidDocumentoClinicoCDA}" extension="EP-F.A" />
 ...
 <component>
   <structuredBody>
				...
				<#if documento.sintomas??>
	     		...
	     		<paragraph>
				    <caption>
				   	...
				   	${documento.tratamientoDado}
			 	</paragraph>
		   	</text>
	   	</section>
	 </component>
 
 	<#if documento.alimentos??>
 		<#if documento.alimentos?size != 0 >
			 <component>
			   	<section>
			     	<title>
			     		Alimentos ingeridos
			     	...
			     	<text>
						<table>
							<tbody>
								<tr>
									<th colspan="4">
										Listado de alimentos ingeridos
									</th>
								</tr>
								<tr>
									<th>
					              ...
					              <#list documento.alimentos as alimento>
					                  <tr>							   	 
					                    <td>							                      
					                      ${alimento.nombre}
					                    </td>
					                    <td>							                      
					                      ${fechaFormateador.format(alimento.fechaIngestion)}
					                    </td>
					                    <td>							                      
					                      ${alimento.lugarConsumo}
					                    </td>
					                    <td>							                      
					                      ${alimento.dia}
					                    </td>
 	...
 	<#if documento.muestras??>
	 	<#if documento.muestras?size != 0 >
			 <component>
			   	<section>
			     	<title>
			     		Muestras cl&#237;nicas y de documentos tomadas y enviadas
			     	</title>
			     	<text>
						<table>
							<tbody>
								...
								<tr>
					              ...
					              <#list documento.muestras as muestra>
					                  <tr>							   	 
					                    <td>							                      
					                      ${muestra.nombre}
					                    </td>
					                    ...
					                    <td>							                      
					                      ${fechaFormateador.format(muestra.fechaEnvio)}
					                    </td>
					                    <td>							                      
					                      ${muestra.lugarEnvio}
					                    </td>
					                    ...
					                    <td>							                      
					                      ${fechaFormateador.format(muestra.fechaResultado)}
					                    </td>
					                  </tr>				   								    		
					              </#list>				          
							</tbody>

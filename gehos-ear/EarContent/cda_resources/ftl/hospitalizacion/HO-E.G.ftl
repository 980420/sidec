...
<ClinicalDocument xmlns="urn:hl7-org" classCode="DOCCLIN" moodCode="EVN">
	...
	<templateId root="${documento.oidDocumentoClinicoCDA}" extension="HO-E.G" />
	 ...
	 <component>
	   	<section>
			...
			<text>
   						...
   						<tr>
	       					...
	       					<td>
	       						<#if documento.fechaIngreso??>
									${fechaFormateador.format(documento.fechaIngreso)}
								<#else>
									-
								</#if>
	       					</td>				       					
	       					...
	       					<td>
	       						<#if documento.fechaEgreso??>
									${fechaFormateador.format(documento.fecha)}
								<#else>
									-
								</#if>
	       					</td>	
	       					...
	       					<td>
	       						<#if documento.servicioTratante??>
									${documento.servicioTratante}
								<#else>
									-
								</#if>
	       					</td>		       					
	       		...
	       		<#if documento.motivoIngreso??>	 
	       			<#if documento.motivoIngreso?size != 0 >			
			 			<table>
		   					<tbody>
		   						<tr>
		   							<th colspan="2">
								...
								<#list documento.motivoIngreso as motivo>
									<tr>
										<td>
											${motivo.codigo}
										</td>
			    ...
			    <table>
			    	<tbody>				    				       							       				
						<tr>
	       					...
	       					<td>
	       						<#if documento.tipoEgreso??>
									${documento.tipoEgreso}
								<#else>
									-
								</#if>
	       					</td>	       					
			...
			<#if documento.tipoEgreso == 'Fallecimiento' || documento.tipoEgreso == 'fallecimiento'>
				<component>
				   	<section>
				     	<title>
							...
							<table>
			   					<tbody>			       							       				
									<tr>
				       					...
				       					<td>
				       						<#if documento.fechaEgreso??>
												${fechaFormateador.format(documento.fechaDefuncion)}
											<#else>
												-
											</#if>
				       					</td>
				       					...
				       					<td>
				       						<#if documento.fechaEgreso??>
												${horaFormateador.format(documento.horaDefuncion)}
											<#else>
												-
											</#if>
				       					</td>
					   				...
					   				<table>
					   					<tbody>   						
					   						<tr>
						       					...
						       					<td>
						       						Enfermedades o estado patol&#243;gico que finalmente produjo la muerte.
						       					</td>		       					
						       				</tr>
						       				<tr>
						       					<td colspan="2">
							       					<paragraph>
													    <caption>
													   	...
													   	<#if documento.causaMuerteA??>
																${documento.causaMuerteA}
														<#else>
															-
														</#if>													   
												 	</paragraph>
						       				...
						       				<tr>				       					
						       					<td colspan='2'>
						       						Causas que antecedieron a la causa directa si existen. La &#255;ltima causa anotada en B, C o D ser&#250; la que inici&#243; todo el proceso patol&#243;gico.
						       					</td>		       					
						       				</tr>
						       				<tr>
						       					<td colspan="2">
							       					<paragraph>
													    <caption>
													    	B) Causa que ocasion&#243; lo anotado en Parte I A
													    </caption>
													   	<#if documento.causaMuerteB??>
																${documento.causaMuerteB}
														<#else>
															-
														</#if>
												 	</paragraph>
						       				...
						       				<tr>
						       					<td colspan="2">
							       					<paragraph>
													    <caption>
													    	C) Causa que ocasion&#243; lo anotado en Parte I B
													    </caption>
													   	<#if documento.causaMuerteC??>
																${documento.causaMuerteC}
														<#else>
															-
														</#if>
												 	</paragraph>
						       				...
						       				<tr>
						       					<td colspan="2">
							       					<paragraph>
													    <caption>
													    	D) Causa que ocasion&#243; lo anotado en Parte I C
													    </caption>
													   	<#if documento.causaMuerteD??>
																${documento.causaMuerteD}
														<#else>
															-
														</#if>
												 	</paragraph>
						       				...
						       				<tr>
						       					...
						       					<td>
						       						Otras enfermedades significativas que contribuyeron a la muerte, pero no relacionadas con la causa directa (I A).
						       					</td>		       					
						       				</tr>	
						       				<tr>
						       					<td colspan="2">
							       					<paragraph>
													    ...
													    <#if documento.causaMuerteOtras??>
																${documento.causaMuerteOtras}
														<#else>
															-
														</#if>
												 	</paragraph>
					   				...
					   				<table>
					   					<tbody>
					   						<tr>
						       					...
						       					<td>
						       						<#if documento.confirmacionMuerteClinica>
						       							S&#237;
						       						<#else>
						       							No
						       						</#if>
						       					...
						       					<td>
						       						<#if documento.confirmacionMuerteInvestigacion>
						       							S&#237;
						       						<#else>
						       							No
						       						</#if>
						       					...
						       					<td>
						       						<#if documento.confirmacionMuerteOperacion>
						       							S&#237;
						       						<#else>
						       							No
						       						</#if>
						       					...
						       					<td>
						       						<#if documento.confirmacionMuerteBiopsia>
						       							S&#237;
						       						<#else>
						       							No
						       						</#if>
						       					...
						       					<td>
						       						<#if documento.confirmacionNecropsia>
						       							S&#237;
						       						<#else>
						       							No
						       						</#if>
			...
			<#if documento.observaciones?? || documento.resumenHistoriaClinica??>	
		 		<component>
				   	<section>
				     	<text>
						 	...
						 	<#if documento.resumenHistoria??>
							 	<paragraph>
								    <caption>
								    	Conclusiones
								    </caption>
								   	${documento.resumenHistoria}
							 	</paragraph>
							 </#if>
			          	</text>
	          		</section>

...
@Name("cronogramasVisualizarCutomList_ensayo")
public class CronogramasVisualizarCutomList_ensayo extends CronogramaList_ensayo{
	...
	private static final String EJBQL = "select cronograma from Cronograma_ensayo cronograma "
			...
			//+ "and cronograma.estadoCronograma.codigo >= 2 "//Cronogramas en estado Nuevo o Elaboracion
	...
	private static final String[] RESTRICTIONS = {
		"lower (cronograma.grupoSujetos.nombreGrupo) like concat('%', concat(lower(#{cronogramasVisualizarCutomList_ensayo.nombreGrupo}),'%'))",
		"cronograma.fechaCreacion >= #{cronogramasVisualizarCutomList_ensayo.desde}",
		"cronograma.fechaCreacion <= #{cronogramasVisualizarCutomList_ensayo.hasta}"};
	...
	public CronogramasVisualizarCutomList_ensayo() {
		setEjbql(EJBQL);

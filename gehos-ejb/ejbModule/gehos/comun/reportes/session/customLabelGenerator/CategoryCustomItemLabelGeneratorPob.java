...
public class CategoryCustomItemLabelGeneratorPob  extends AbstractCategoryItemLabelGenerator
implements CategoryItemLabelGenerator, Cloneable, Serializable {
     ...
     */
    public CategoryCustomItemLabelGeneratorPob() {
     ...
     */
    public CategoryCustomItemLabelGeneratorPob(String labelFormat,
    ...
    public String generateLabel(CategoryDataset dataset, int row, int column) {
        ...
        return nf.format(Math.abs((Double)dataset.getValue(row, column)));
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof CategoryCustomItemLabelGeneratorPob)) {
            return false;
        }

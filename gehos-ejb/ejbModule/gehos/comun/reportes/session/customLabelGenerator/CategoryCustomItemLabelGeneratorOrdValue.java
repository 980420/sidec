...
public class CategoryCustomItemLabelGeneratorOrdValue  extends AbstractCategoryItemLabelGenerator
implements CategoryItemLabelGenerator, Cloneable, Serializable {
     ...
     */
    public CategoryCustomItemLabelGeneratorOrdValue() {
     ...
     */
    public CategoryCustomItemLabelGeneratorOrdValue(String labelFormat,
    ...
    public String generateLabel(CategoryDataset dataset, int row, int column) {
        ...
        return dataset.getRowKey(row).toString().substring(0, 3) + "/" + dataset.getValue(row, column).toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof CategoryCustomItemLabelGeneratorOrdValue)) {
            return false;
        }

...
<ClinicalDocument xmlns="urn:hl7-org" classCode="DOCCLIN" moodCode="EVN">
	...
	<templateId root="${documento.oidDocumentoClinicoCDA}" extension="EF-H.SV" />
   ...
   <structuredBody>
     ...
     <component>
	   	<section>
	     	...
	     	<text>
	     		<#if documento.reportesEnf??>
		     		<#if documento.reportesEnf?size != 0 >
						<table>
							<tbody>
								<tr>
									<th colspan="4">
										Listado de reportes de enfermer&#237;a
									</th>
								</tr>
								<tr>
									<th>
					            ...
					            <#list documento.reportesEnf as reporte>
					                <tr>							   	 
					                    <td>							                      
					                      ${fechaFormateador.format(reporte.fechaReporte)}
					                    </td>
					                    <td>							                      
					                      ${horaFormateador.format(reporte.horaReporte)}
					                    </td>
					                </tr>			   								    		
					            </#list>
							</tbody>
	 ...
	 <component>
	  <section>
	    <title>
	   		Gr&#225;fica de los signos vitales
	    </title>
	    <nonXMLBody>
			<text mediaType="application/png" representation="B64">
				${documento.encodedImage()}
			</text>
		</nonXMLBody>
	  </section>
	</component>

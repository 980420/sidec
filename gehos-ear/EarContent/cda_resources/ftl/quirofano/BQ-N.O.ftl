...
<ClinicalDocument xmlns="urn:hl7-org" classCode="DOCCLIN" moodCode="EVN">
	...
	<templateId root="${documento.oidDocumentoClinicoCDA}" extension="BQ-N.O" />
   				...
   				<table>
   					<tbody>		
   						<tr>
							...
							<td colspan="3">
								${documento.Cirujano.nombreCompleto()}
							</td>
						</tr>
						<tr>
							<td>

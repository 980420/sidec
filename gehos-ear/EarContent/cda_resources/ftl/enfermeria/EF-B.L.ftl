...
<ClinicalDocument xmlns="urn:hl7-org" classCode="DOCCLIN" moodCode="EVN">
	...
	<templateId root="${documento.oidDocumentoClinicoCDA}" extension="EF-B.L" />
   				...
   				<table>
   					<tbody>
						...
						<tr>
	       					...
	       					<td>
	       						${fechaFormateador.format(documento.horaIngreso)}
	       					</td>		       					
	       				</tr>
   					</tbody>
   				</table>
   				...
   				<table>
   					<tbody>
   						<tr>
	       					...
	       					<td>
	       						${documento.pesoIngreso}
	       					</td>				       					
	       					<td>
	       						Peso de actual
	       					</td>				       					
	       					<td>
	       						${documento.pesoActual}
	       					</td>			       					
	       				</tr>
   					</tbody>
   				</table>
				...
				<table>
					<tbody>
						...
						<tr>
							...
							<td>							                      
			                	${documento.tratamientoEndo}
			                </td>
							<td>
								Hidratación parenteral
							</td>
							<td>							                      
			                	${documento.hidraPaternalEndo}
			                </td>
			           	</tr>
						<tr>
							<td>
							...
							<td>							                      
			                	${documento.nutriPaternalEndo}
			                </td>
							<td>
								Sangre
							</td>
							<td>							                      
			                	${documento.sangreEndo}
			                </td>
			            </tr>
						<tr>
							<td>
				...
				<table>
					<tbody>
						...
						<tr>
							...
							<td>							                      
			                	${documento.tipoLiquidoOral}
			                </td>
							<td>
								Cantidad
							</td>
							<td>							                      
			                	${documento.cantidadOral}
			                </td>
							<td>
								Total
							</td>

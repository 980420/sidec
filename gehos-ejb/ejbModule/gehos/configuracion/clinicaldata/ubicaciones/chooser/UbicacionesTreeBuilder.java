package gehos.configuracion.clinicaldata.ubicaciones.chooser;
...
@Name("ubicacionesChooserTreeBuilder")
public class UbicacionesTreeBuilder {
	...
	private Long selectedEntity = new Long(-1);
	...
	// @Begin(join = true)
	public boolean putSelectedEntity(Long entidadId) {
		if (!this.selectedEntity.equals(entidadId)) {

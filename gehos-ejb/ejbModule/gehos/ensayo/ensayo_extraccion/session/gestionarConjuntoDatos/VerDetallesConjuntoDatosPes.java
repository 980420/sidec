...
@Name("verDetallesConjuntoDatosPes")
@Scope(ScopeType.CONVERSATION)
public class VerDetallesConjuntoDatosPes
{
	@In
	...
	private List<VariableConjuntoDatos> listadoVariablesSeleccionadas = new ArrayList();
	List<String> listadoIdMomentos = new ArrayList();
	List<String> listadoIdVariables = new ArrayList();

	public VerDetallesConjuntoDatosPes() {}

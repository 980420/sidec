...
@Name("reanudarInclusion")
@Scope(ScopeType.CONVERSATION)
public class ReanudarInclusion {
	...
	public String validarCampo() {
		if (causa != null) {
			...
			if (causa != null && noExtranno && longitud <= 250) {
				causa = null;
				return "Richfaces.showModalPanel('mpAdvertenciaReanudarInclusion')";
			}
		}
		return "";
	}
	...
	public void CambiarSujetoCentro() {
		...
		EstadoEstudio_ensayo estadoEstudio = (EstadoEstudio_ensayo)entityManager
				.createQuery(
						"select momento from EstadoEstudio_ensayo momento where momento.codigo = 3")
				.getSingleResult();

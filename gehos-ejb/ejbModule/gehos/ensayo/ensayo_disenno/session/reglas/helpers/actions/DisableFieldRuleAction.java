...
@Name("DisableFieldRuleAction")
@Scope(ScopeType.CONVERSATION)
@SuppressWarnings({"unchecked","rawtypes"})
public class DisableFieldRuleAction extends IRuleAction{
	...
	public String getLabel() {
			return "Deshabilitar campo";
	}
	@Override
	public String getDescription() {
		return "Deshabilita el campo relacionado con la variable seleccionada";
	}
	...
	public String Resume() {		
		return "Se deshabilitar\u00E1 el campo asociado a la variable " + this.variable.getNombreVariable();
	}
	
	@Override
	public String InstanceDescription() {		
		return "Deshabilitar " + variable.getNombreVariable();
	}
	...
	public IRuleAction OppositeAction() {		
		return new EnableFieldRuleAction();
	}

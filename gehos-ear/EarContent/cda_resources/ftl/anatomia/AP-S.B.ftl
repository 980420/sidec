...
<ClinicalDocument xmlns="urn:hl7-org" classCode="DOCCLIN" moodCode="EVN">
	...
	<templateId root="${documento.oidDocumentoClinicoCDA}" extension="AP-S.B" />
	 ...
	 <component>
	   <section>
	     ...
	     <text>
	     	...
	     	<paragraph>
     			<caption>Biopsia Anterior</caption>
	    				${documento.informeBex}
     		</paragraph>
     		
     		<paragraph>
     			<caption>Citologia Anterior</caption>
	    				${documento.informeCex}
     		</paragraph>
	     	  	
	     	<paragraph>
	   			 <caption>Motivo de consulta</caption>
	    				${documento.motivoConsulta}
			 </paragraph>
			 		 
			 <paragraph>
	   			 <caption>Hallazgos significativos</caption>
	    				${documento.hallazgoSignificativo}
			 </paragraph>	
			 	 
			 <paragraph>
	   			 <caption>Diagn&#243;sticos</caption>
	    				${documento.diagnostico}
			 </paragraph>
			 
			 <paragraph>
	   			 <caption>Tratamiento&#44;evoluci&#243;n&#44;recomendaciones</caption>
	    				${documento.recomendaciones_Tratamiento_Evolucion}
			 </paragraph>
			 
			  <paragraph>
	   			 <caption>Fecha de &#250;ltima regla &#40;FUR&#41;</caption>
	    				${fechaFormateador.format(documento.fechaUltimaRegla)}
			 </paragraph>   	
	     </text>
	   </section>
	 </component> 
	 <component>
			<section>
		    	 <title>Origen del documento</title>
		    	 	<text>
		    	 		<paragraph>
		   			 		<caption>Establecimiento </caption>
		    					${documento.establecimientoRemitenteR}
						 </paragraph> 
						 
						 <paragraph>
		   			 		<caption>Nombre del establecimiento</caption>
		    					${documento.nombreEstablecimientoR}
						 </paragraph>
						 
						 <paragraph>
						 	<caption>Departamento</caption>
		    					${documento.departamentoR}
						 </paragraph>
						 
						 <paragraph>
						 	<caption>Servicio</caption>
		    					${documento.servicioRemitente}
						 </paragraph>  					 	 
		    	 	</text>
		 	</section>
	 </component>   
	  <component>
	  		<section>
	    	 <title>Destino del documento</title>
	    	 	<text>
	    	 		<paragraph>
	   			 		<caption>Establecimiento</caption>
	    					${documento.establecimientoRemitenteD}
					 </paragraph> 
					 
					 <paragraph>
	   			 		<caption>Nombre del establecimiento</caption>
	    					${documento.nombreEstablecimientoD}
					 </paragraph>
					 
					 <paragraph>
					 	<caption>Departamento</caption>
	    					${documento.departamentoD}
					 </paragraph>
					 
					 <paragraph>
					 	<caption>Servicio</caption>
	    					${documento.servicioRemitenteD}
					 </paragraph>  					 	 
	    	 	</text>
	 		</section>
	  </component>
	  <component>
	    	 ...
	    	 <title>Otros datos</title>
	    	 	<text>
	    	 		<paragraph>
	   			 		<caption>Tipo de muestra</caption>
	    					${documento.tipoMuestra}
					 </paragraph> 				 				 	 
	    	 	</text>
	 		</section>
	  </component> 

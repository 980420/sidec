...
<ClinicalDocument xmlns="urn:hl7-org" classCode="DOCCLIN" moodCode="EVN">
	...
	<templateId root="${documento.oidDocumentoClinicoCDA}" extension="HO-S.CG" />
...
<!-- Aqui comienza el cuerpo del documento -->
 <component>
   <structuredBody>   
	     ...
	     <text>
	     	<paragraph>
	     		<caption>Biopsia anterior</caption>
	    				${documento.biopsiaAnterior}     	
	     	</paragraph>     	
	     	<paragraph>
	     		<caption>Citolog&#237;a anterior</caption>
	    				${documento.citologiaAnterior}     	
	     	</paragraph>     	
	     	<paragraph>
			 ...
			 <paragraph>
	   			 <caption>Hallazgos significativos</caption>
	    				${documento.hallazgosSignificativos}
			 </paragraph>		 
			 <paragraph>
			 ...
			 <paragraph>
			  ...
			  <paragraph>
	   			 <caption>Fecha de &#250;ltima regla &#40;FUR&#41;</caption>
	    				${fechaFormateador.format(documento.fechaURegla)}
			 </paragraph>   	
	     </text>
	   </section>
	 </component> 
	 <component>
			<section>
		    	 <title>Origen de la documento</title>
		    	 	<text>
		    	 		<paragraph>
						 ...
						 <paragraph>
		    					...
		    					${documento.nombreEstablecimiento}
						 </paragraph>
						 <paragraph>
	  ...
	  <component>
	  		<section>
	    	 <title>Destino de la documento</title>
	    	 	<text>
	    	 		<paragraph>
	   			 		<caption>Establecimiento</caption>
	    					${documento.establecimiento}

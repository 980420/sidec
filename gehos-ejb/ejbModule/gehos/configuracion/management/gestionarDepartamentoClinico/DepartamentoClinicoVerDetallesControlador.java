...
@Name("departamentoClinicoVerDetallesControlador")
public class DepartamentoClinicoVerDetallesControlador {
		...
		try {
			...
			departamento = (Departamento_configuracion) 
			 			   entityManager.createQuery("select departamento from Departamento_configuracion departamento " +
			 						   	...
			 						   	.getSingleResult();
			//bitacora.registrarInicioDeAccion(SeamResourceBundle.getBundle().getString("bitDetalles"));

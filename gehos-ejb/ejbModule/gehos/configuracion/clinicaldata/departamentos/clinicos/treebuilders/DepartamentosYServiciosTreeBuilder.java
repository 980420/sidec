package gehos.configuracion.clinicaldata.departamentos.clinicos.treebuilders;
...
@Name("departamentosYServiciosTreeBuilder")
public class DepartamentosYServiciosTreeBuilder {
	...
	private Hashtable<Long, Departamento_configuracion> departamentosHashtable = new Hashtable<Long, Departamento_configuracion>();
	...
	public void loadData() {
		...
		departamentosHashtable = new Hashtable<Long, Departamento_configuracion>();
		for (Departamento_configuracion departamento : departamentos) {
			departamentosHashtable.put(departamento.getId(), departamento);
		}
	...
	public void setAdministrarClinicos(boolean administrarClinicos) {
		...
		List<Departamento_configuracion> departamentos = entityManager
				...
				.setParameter("admClinicos", this.administrarClinicos)
				.getResultList();
		if (departamentos.size() != departamentosHashtable.size())
			this.loadData();
		for (Departamento_configuracion departamento : departamentos) {
			if (!departamentosHashtable.containsKey(departamento.getId())) {
				this.loadData();
				break;
			}
		}

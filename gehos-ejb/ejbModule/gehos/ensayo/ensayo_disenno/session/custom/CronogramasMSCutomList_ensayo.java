...
@Name("cronogramasMSCutomList_ensayo")
public class CronogramasMSCutomList_ensayo extends CronogramaList_ensayo{
	...
	private static final String[] RESTRICTIONS = {
		"lower (cronograma.grupoSujetos.nombreGrupo) like concat('%', concat(lower(#{cronogramasMSCutomList_ensayo.nombreGrupo}),'%'))",
		"cronograma.fechaCreacion >= #{cronogramasMSCutomList_ensayo.desde}",
		"cronograma.fechaCreacion <= #{cronogramasMSCutomList_ensayo.hasta}"};
	...
	public CronogramasMSCutomList_ensayo() {
		setEjbql(EJBQL);

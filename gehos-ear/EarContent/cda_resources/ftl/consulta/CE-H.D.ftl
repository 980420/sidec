...
<ClinicalDocument xmlns="urn:hl7-org" classCode="DOCCLIN" moodCode="EVN">
	...
	<templateId root="${documento.oidDocumentoClinicoCDA}" extension="HO-H.D" />
 ...
 <component>
   <structuredBody>
	 ...
	 <#if documento.dermatologiaExamGen>
		 <component>
		   	<section>
		     	<title>
		     		Examen general
				</title>
				<#if documento.dermatologiaExamGenLesiones>
			     	<component>
					   	<section>
					     	<text>
					     		<#if documento.piel??>
							 	...
							 	<#if documento.cueroCabelludoPelos??>
								 	<paragraph>
									    <caption>
									    	Cuero cabelludo-pelos
									    </caption>
									   	${documento.cueroCabelludoPelos}
								 	</paragraph>
							 	</#if>
							 	<#if documento.mucosas??>
								 	<paragraph>
									    <caption>
									    	Mucosas
									    </caption>
							 	...
							 	<#if documento.exposicionSustanciasNocivas??>
								 	<paragraph>
									    <caption>
									    	Exposici&#243;n a sustancias potencialmente nocivas
									    </caption>
									   	${documento.exposicionSustanciasNocivas}
								 	</paragraph>
								</#if>
							 	...
							 	<#if documento.sensibilizaciones??>
								 	<paragraph>
									    <caption>
									    	Sensibilizaciones
									    </caption>
									   	${documento.sensibilizaciones}
								 	</paragraph>
								</#if> 
							 	<#if documento.lugaresHabitado??>
								 	<paragraph>
									    <caption>
									    	Lugares en los que ha habitado
									    </caption>
									   	${documento.lugaresHabitado}
								 	</paragraph>
								</#if> 
							 	...
							 	<#if documento.manifestacionesSubjetivas??>
								 	<paragraph>
									    <caption>
									    	Manifestaciones subjetivas
									    </caption>
									   	${documento.manifestacionesSubjetivas}
								 	</paragraph>
							 	</#if>
							 	<#if documento.evolucionLesionesCursoEnfermedad??>
								 	<paragraph>
									    <caption>
									    	Evoluci&#243;n de las lesiones. Curso de la enfermedad
									    </caption>
									   	${documento.evolucionLesionesCursoEnfermedad}
								 	</paragraph>
								</#if>
							 	<#if documento.afeccionesContaminantes??>
								 	<paragraph>
									    <caption>
									    	Afecciones contaminantes
									    </caption>
									   	${documento.afeccionesContaminantes}
								 	</paragraph>
							 	</#if>
							 	<#if documento.biotipo??>
								 	<paragraph>
									    <caption>
									    	Biotipo
									    </caption>
				...
				<#if documento.dermatologiaExamGenSignos>
					<component>
					   	<section>
					     	<title>
					     		Signos vitales
					     	...
					     	<text>
								<#if documento.PADiastolica?? || documento.PASistolica?? || documento.PAMedia??>			 	
					   				<table>
					   					<tbody>
					   						<tr>
					   							<th colspan="4">
					       		...
					       		<#if documento.PValor?? || documento.caracteristicasPulso?? || documento.ubicacionPulso??>
						       		<table>
					   					<tbody>
					   						<tr>
					   							<th colspan="4">
					       		...
					       		<#if documento.temperatura?? || documento.peso?? || documento.talla??>
						       		<table>
					   					<tbody>
					   						<tr>
					   							<th colspan="4">

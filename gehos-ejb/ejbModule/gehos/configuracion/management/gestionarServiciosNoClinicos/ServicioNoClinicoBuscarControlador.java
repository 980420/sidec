...
@Name("servicioNoClinicoBuscarControlador")
@Scope(ScopeType.CONVERSATION)
public class ServicioNoClinicoBuscarControlador extends
		EntityQuery<Servicio_configuracion> {
			...
			"and departamento.eliminado = false";

	private static final String[] RESTRICTIONS = {
			"lower(servicio.nombre) like concat(lower(#{servicioNoClinicoBuscarControlador.servicio.nombre.trim()}),'%')",
			"lower(servicio.codigo) like concat(lower(#{servicioNoClinicoBuscarControlador.servicio.codigo.trim()}),'%')",
			"lower(servicio.departamento.nombre) like concat(lower(#{servicioNoClinicoBuscarControlador.servicio.departamento.nombre}),'%')",
			"lower(servicio.servicio.nombre) like concat(lower(#{servicioNoClinicoBuscarControlador.servicio.servicio.nombre}),'%')",};
	...
	public ServicioNoClinicoBuscarControlador() {
		setEjbql(EJBQL);

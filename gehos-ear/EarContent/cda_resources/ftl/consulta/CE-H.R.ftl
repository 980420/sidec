...
<ClinicalDocument xmlns="urn:hl7-org" classCode="DOCCLIN" moodCode="EVN">
	...
	<templateId root="${documento.oidDocumentoClinicoCDA}" extension="HO-H.R" />
               ...
               <table>
               		<tbody>
						<tr>
                           ...
                           <td>
                           		<#if documento.fechaRemision??>
                              		${fechaFormateador.format(documento.fechaRemision)}
                              	</#if>
                           </td>
                           <td>
                               M&#233;dico que refiere
                           ...
                           <td>
                           		<#if documento.nombreCompleto??>
                               		${documento.autor.nombreCompleto()}
                           		</#if>
                           </td>                                                   </tr>                           <tr>
                           <td>
                               Servicio

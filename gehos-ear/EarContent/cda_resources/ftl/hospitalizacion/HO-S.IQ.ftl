...
<ClinicalDocument xmlns="urn:hl7-org" classCode="DOCCLIN" moodCode="EVN">
	...
	<templateId root="${documento.oidDocumentoClinicoCDA}" extension="HO-S.IQ" />
	   	...
	   	<section>
	     	...
	     	<text>
				<table>
   					<tbody> 												
						<tr>
							<#if documento.servicioQx??>
								<td>
									Servicio quir&#250;rgico
								</td>										
								<td>
									${documento.servicioQx}
								</td>
							</#if>
							<#if documento.duracionAproximada??>
								<td>
									Duraci&#243;n aproximada
								</td>
								<td>
									${documento.duracionAproximada}
								</td>
							</#if>							
						</tr>	
						<tr>
							<#if documento.intervencioEmergencia??>
								<td>
							...
							<#if documento.fechaFijada??>
								<td>
									Fecha fijada
								</td>
								<td>
									${fechaFormateador.format(documento.fechaFijada)}
								</td>
							</#if>							
						</tr>
						<tr>
							<#if documento.quirofano??>
								<td>
									Quir&#243;fano
								</td>
								<td colspan="3">
						...
						<tr>
							<#if documento.causasCambioQuirofano??>
								<td>
									Causas cambio de quir&#243;fano
								</td>										
								<td colspan="3">
									${documento.causasCambioQuirofano}
								</td>
							</#if>													
						</tr>	
						<tr>
							<#if documento.funcionarioAprueba??>
								<td>
									Funcionario que aprueba
								</td>										
								<td>
									${documento.funcionarioAprueba.nombreCompleto()}
								</td>
							</#if>
							<#if documento.aprobacion??>
								<td>
									Aprobaci&#243;n
								</td>										
								<td>
									<#if documento.aprobada>
										Aprobada
									<#else>
										Rechazada
									</#if>
						...
						<#if documento.causasRechazo??>	
							<tr>
								<td>
									Causas del rechazo
								</td>										
								<td colspan="3">
									${documento.causasRechazo}
								</td>											
							</tr>
						</#if>
						<tr>
				...
				<#if documento.enfermedadesDiag??>
					<table>
						<tbody>
							...
							<tr>
								<th>
									Cod. de la enfermedad
								</th>
								<th>
									Nombre de la enfermedad
								</th>
							</tr>	 					 		 
				              <#list documento.enfermedadesDiag as enf>
				                  <tr>							   	 
				                    <td>							                      
				                      ${enf.codigo}
				                    </td>
				...
				<#if documento.procedimientoQx??>
					<paragraph>
					    <caption>
					    	Procedimiento quir&#250;rgico
					    </caption>
					   	${documento.procedimientoQx}
				 	</paragraph>
			 	</#if>
			 	
			 	<#if documento.cirujanos??>
			 		<#if documento.cirujanos?size !=0 >
					 	<table>
							<tbody>
								<tr>
									<th colspan="3">
								...
								<tr>
					              ...
					              <#list documento.cirujanos as cirujano>
					                  <tr>							   	 
					                    <td>							                      
					                      ${cirujano.nombre}
					                    </td>
				...
				<#if documento.anesteciologos??>
					<#if documento.anesteciologos?size !=0 >
					 	<table>
							<tbody>
								<tr>
									<th colspan="3">
										Anesteci&#243;logos Seleccionados
									</th>
								</tr>
								<tr>
									<th>
					              ...
					              <#list documento.anesteciologos as anesteciologo>
					                  <tr>							   	 
					                    <td>							                      
					                      ${anesteciologo.nombre}
					                    </td>
					                    <td>							                      
					                      ${anesteciologo.apellido1}
					                    </td>
					                    <td>							                      
					                      ${anesteciologo.apellido2}
					                    </td>
					                  </tr>			   								    		
					              </#list>
							</tbody>
				...
				<#if documento.otrosAnesteciologos??>
					<#if documento.otrosAnesteciologos?size !=0 >
					 	<table>
							<tbody>
								<tr>
									<th colspan="3">
								...
								<tr>
					              ...
					              <#list documento.otrosAnesteciologos as anesteciologo>
					                  <tr>							   	 
					                    <td>							                      
					                      ${anesteciologo.nombre}
					                    </td>
				...
				<#if documento.enfermeras??>
					<#if documento.enfermeras?size !=0 >
					 	<table>
							<tbody>
								<tr>
									<th colspan="3">
								...
								<tr>
					              ...
					              <#list documento.enfermeras as enfermera>
					                  <tr>							   	 
					                    <td>							                      
					                      ${enfermera.nombre}
					                    </td>
				...
				<#if documento.otrasEnfermeras??>
					<#if documento.otrasEnfermeras?size !=0 >
					 	<table>
							<tbody>
								<tr>
									<th colspan="3">
								...
								<tr>
					              ...
					              <#list documento.otrasEnfermeras as enfermera>
					                  <tr>							   	 
					                    <td>							                      
					                      ${enfermera.nombre}
					                    </td>
				...
				<#if documento.ayudantes??>
					<#if documento.ayudantes?size !=0 >
						<table>
							<tbody>
								<tr>
									<th colspan="3">
								...
								<tr>
					              ...
					              <#list documento.ayudantes as ayudante>
					                  <tr>							   	 
					                    <td>							                      
					                      ${ayudante.nombre}
					                    </td>
				...
				<#if documento.equipos??>
					<#if documento.equipos?size !=0 >
						<list>        
			              	<caption>
			              		Equipos seleccionados
			              	</caption>                
			                <#list documento.equipos as equipo>
			                   <item>${equipo}</item>		
			                </#list>
		              	</list>
	              	</#if>
              	...
              	<#if documento.dispositivos??>
	              	<#if documento.dispositivos?size !=0 >
		              	<list>        
			              	<caption>
			              		Dispositivos seleccionados
			              	</caption>                
			                <#list documento.dispositivos as dispositivo>

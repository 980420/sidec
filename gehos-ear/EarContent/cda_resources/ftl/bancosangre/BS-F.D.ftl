...
<ClinicalDocument xmlns="urn:hl7-org" classCode="DOCCLIN" moodCode="EVN">
	...
	<templateId root="${documento.oidDocumentoClinicoCDA}" extension="BS-F.D" />
	  ...
	  <component>
		   <section>
			     <title> Datos de la ficha </title>
				     <text>
				     	<paragraph>
			    	 		<caption>Resultado de ex&#225;menes</caption>
			    				${documento.resultadoExamenes}     	
			     		</paragraph>     
			     		<paragraph>
			     			<caption>Fecha de donaci&#243;n</caption>
		    					${fechaFormateador.format(documento.fechaDonacion)}     	
			     		</paragraph> 
		 				<paragraph>
			     			<caption>Grupo sangu&#237;neo</caption>
		    					${documento.grupoSanguineo}     	
			     		</paragraph> 
		     		</text>
			</section>	
	 	</component>

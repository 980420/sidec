...
@Name("crearConjuntoDatosPes")
@Scope(ScopeType.CONVERSATION)
public class CrearConjuntoDatosPes
{
	@In
	...
	public void inicializarConjuntoDatos() {
		...
		cronogramas = entityManager.createQuery("select distinct cronograma from Cronograma_ensayo cronograma "
				...
				+ "where grupoSujetos.nombreGrupo<>'Grupo Validación' and grupoSujetos.estudio.id =:idEstudio and grupoSujetos.nombreGrupo =:nombreGrupo and cronograma.eliminado<>true and momentoSeguimientoGenerals.eliminado<>true")
		...
		List<Object> variables = entityManager.createQuery("select variable, momentoSeguimientoGeneral from Variable_ensayo variable "
				...
				+ "and momentoSeguimientoGeneral.eliminado <> true and cronograma in (#{crearConjuntoDatosPes.cronogramas}) "
	...
	public String insertarConjuntoDatos() {
		try {
			...
			conjuntoDatos.setPesquisaje(true);

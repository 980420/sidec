...
// Generated 29-abr-2019 11:54:14 by Hibernate Tools 3.4.0.CR1
...
/**
 * LogEventosDisenno generated by hbm2java
 */
@Entity
@Table(name = "log_eventos_disenno", schema = "ensayo")
public class LogEventosDisenno_ensayo implements java.io.Serializable {
	...
	public LogEventosDisenno_ensayo() {
	}

	public LogEventosDisenno_ensayo(long id, String tablaAuditada) {
		this.id = id;
	...
	public LogEventosDisenno_ensayo(long id, String tablaAuditada,
			...
			String estudioNombre, String gsNombre, String cronograma,
			String etapa, String msgNombre, String hojaCrd, String seccion,
			String variableNombre, String regla, Date fechaAuditoria,
			String hora, Long idEst) {
		this.id = id;
		this.tablaAuditada = tablaAuditada;

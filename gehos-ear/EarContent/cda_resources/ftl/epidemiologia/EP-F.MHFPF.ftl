...
<ClinicalDocument xmlns="urn:hl7-org" classCode="DOCCLIN" moodCode="EVN">
	...
	<templateId root="${documento.oidDocumentoClinicoCDA}" extension="EP-F.MHFPF" />
						...
						<table>
							<tbody>
								...
								<tr>	       									
									...
									<td>
										${fechaFormateador.format(documento.muestra1.fechaToma)}
									</td>
									...
									<td>
										${fechaFormateador.format(documento.muestra1.fechaEnvio)}
									</td>
								</tr>																	
								<tr>
									<td>
									...
									<td>
										${fechaFormateador.format(documento.muestra1.fechaRecepcion)}
									</td>																		
									<td>
										Fecha de reporte
									</td>																		
									<td>
										${fechaFormateador.format(documento.muestra1.fechaResultado)}
									</td>
								</tr>																	
								<tr>
									<td>
			       		...
			       		<table>
							<tbody>
								...
								<tr>	       									
									...
									<td>
										${fechaFormateador.format(documento.muestra2.fechaToma)}
									</td>
									...
									<td>
										${fechaFormateador.format(documento.muestra2.fechaEnvio)}
									</td>
								</tr>																	
								<tr>
									<td>
									...
									<td>
										${fechaFormateador.format(documento.muestra2.fechaRecepcion)}
									</td>																		
									<td>
										Fecha de reporte
									</td>																		
									<td>
										${fechaFormateador.format(documento.muestra2.fechaResultado)}
									</td>
								</tr>																	
								<tr>
									<td>

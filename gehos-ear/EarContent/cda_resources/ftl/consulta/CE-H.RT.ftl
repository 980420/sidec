...
<ClinicalDocument xmlns="urn:hl7-org" classCode="DOCCLIN" moodCode="EVN">
	...
	<templateId root="${documento.oidDocumentoClinicoCDA}" extension="CE-H.RT" />
 ...
 <component>
   <structuredBody>
	 ...
	 <component>
	   	<section>
	     	...
	     	<text>
	     		<paragraph>
				    <caption>
				    	Estado general, examen locoregional detallado del &#225;rea de inter&#233;s
				    </caption>
				   	${documento.piel}
			 	</paragraph>
	 ...
	 <#if documento.enfermedadesImpDiag??>
		 <#if documento.enfermedadesImpDiag?size != 0 >
			 <component>
			   	<section>
			     	<title>
	 ...
	 <#if documento.enfermedadesDiagFinal??>
		 <#if documento.enfermedadesDiagFinal?size != 0 >
			 <component>
			   	<section>
			     	<title>
			     		Diagn&#243;stico final
						...
						<table>
							<tbody>
								...
								<tr>
					              ...
					              <#list documento.enfermedadesDiagFinal as enf>
					                  <tr>							   	 
					                    <td>							                      
					                      ${enf.codigo}
					                    </td>

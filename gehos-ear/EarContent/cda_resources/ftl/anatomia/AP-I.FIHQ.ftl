...
<ClinicalDocument xmlns="urn:hl7-org" classCode="DOCCLIN" moodCode="EVN">
	...
	<templateId root="${documento.oidDocumentoClinicoCDA}" extension="AP-I.FIHQ" />
	 ...
	 <component>
			<section>
		    	 <title>Inmunohistoqu&#237;mica </title>
		    	 	<text>
		    	 		<paragraph>
		   			 		<caption>N&#250;mero de inmunohistoqu&#237;mica </caption>
		    					${documento.numeroInmunohistoquimica}
						 </paragraph>  	
						 <paragraph>
		   			 		<caption>N&#250;mero de inmunoreacciones </caption>
		    					${documento.numeroInmunoreacciones}
						 </paragraph>  	 					 	 
		    	 	</text>
		 	</section>
	 </component>   

...
@Name("servicioClinicoModificarControlador")
public class ServicioClinicoModificarControlador {
	...
	public void setServicioId(Long id) {
		...
		try {
			...
			cid = bitacora
					.registrarInicioDeAccion(SeamResourceBundle.getBundle().getString("bitModificar"));
	...
	public void filtrarDepartamento() {
		...
		categoriaSeleccionada = "";
		subCateogoriaSeleccionada = "";
		this.servicio.setServicio(null);
	}

package gehos.configuracion.clinicaldata.departamentos.porentidad.treebuilders;
...
@Name("departamentosPorEntidadTreeBuilder")
...
//							"from Entidad_configuracion ent where ent.eliminado = false and ent.perteneceARhio = true order by ent.nombre")
					.getResultList();

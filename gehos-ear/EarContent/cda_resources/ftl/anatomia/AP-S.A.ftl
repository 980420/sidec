...
<ClinicalDocument xmlns="urn:hl7-org" classCode="DOCCLIN" moodCode="EVN">
	...
	<templateId root="${documento.oidDocumentoClinicoCDA}" extension="AP-S.A" />
   ...
   <structuredBody> 
	 ...
	 <component>
	   <section>
	     ...
	     <text>	     
	     	<paragraph>
	     		<caption>Establecimiento Remitente</caption>	     			
	    				${documento.establecimientoRemitente}
	     	...
	     	<paragraph>
	   			 <caption>Servicio remitente</caption>
		    	 ...
		    	 <title>Otros datos</title>
		    	 	<text>
		    	 		<paragraph>
		    					...
		    					${fechaFormateador.format(documento.informeA.fechaMuerte)}
						 </paragraph> 
						 <paragraph>
		   			 		<caption>Hora de muerte</caption>
		    					${horaFormateador.format(documento.informeA.horaMuerte)}
						 </paragraph>						 
						 <paragraph>
						 	<caption>Resumen de la historia m&#233;dica</caption>
		    					${documento.resumenHistoriaM}
						 </paragraph>  
						 <paragraph>	
						 <caption>Diagn&#243;stico cl&#237;nico</caption>
		    					${documento.diagnosticoClinico}
						 </paragraph>				 	 
		    	 	</text>
		 	</section>
	 </component> 	   

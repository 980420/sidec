...
<ClinicalDocument xmlns="urn:hl7-org" classCode="DOCCLIN" moodCode="EVN">
	...
	<templateId root="${documento.oidDocumentoClinicoCDA}" extension="EP-F.INH" />
 ...
 <component>
   <structuredBody>
   				...
   				<table>
   					<tbody>
   						<tr>
							...
							<td>
								${documento.ficha.numeroFicha}
							</td>										
							<td>
								Semana epidemiolog&#237;ca
							</td>										
							<td>
								${documento.ficha.semana}
							</td>
						</tr>									
						<tr>
							<td>
							...
							<td>
								${fechaFormateador.format(documento.ficha.fecha)}
							</td>										
							<td>
								Distrito/municipio sanitario
							</td>										
							<td>
								${documento.ficha.distritoMunSanitario}
							</td>
						</tr>									
						<tr>
							<td>
							...
							<td>
								${documento.ficha.establecimiento}
							</td>										
							<td>
								Estado
							</td>										
							<td>
								${documento.ficha.estado}
							</td>
						</tr>									
						<tr>
							<td>
							...
							<td>
								${documento.ficha.municipio}
							</td>										
							<td>
								Parroquia
							</td>										
							<td>
								${documento.ficha.parroquia}
							</td>
						</tr>
   					</tbody>
   				</table>
   				...
   				<table>
   					<tbody>
   						<tr>
	       					...
	       					<td>
	       						${documento.paciente.nacionalidad}
	       					</td>				       					
	       					<td>
	       						Etnia
	       					</td>				       					
	       					<td>
	       						${documento.paciente.etnia}
	       					</td>			       					
	       				</tr>				       							       				
						<tr>
	       					<td>
	       					...
	       					<td>
	       						${documento.paciente.lugarNacimiento}
	       					</td>				       					
	       					<td>
	       						Tel&#233;fono
	       					</td>				       					
						...
						<tr>
	       				...
	       				<tr>
	       					...
	       					<td>
	       						${documento.paciente.estadoCivil}
	       					</td>				       					
	       					<td>
	       						Nombre del padre
	       					</td>				       					
	       					<td>
	       						${documento.paciente.padre.nombreCompleto()}
	       					</td>
	       				</tr>				       				
	       				<tr>
	       					<td>
	       					...
	       					<td>
	       						${documento.paciente.madre.nombreCompleto()}
	       					</td>
	       				</tr>
   					</tbody>
   				</table>
					...
					<tbody>
						...
						<tr>
							<td>
	       					...
	       					<td colspan="5">
	       						${documento.paciente.direccion.calle}
	       					</td>
						</tr>
						...
						<tr>
							<td>
	       					...
	       					<td>
	       						${documento.paciente.direccion.estado}
	       					</td>
							...
							<td>
	       					...
	       					<td>
	       						${documento.paciente.direccion.municipio}
	       					</td>							       					
							<td>
	       						Parroquia
	       					</td>							       					
	       					<td>
	       						${documento.paciente.direccion.parroquia}
	       					</td>		
	       				</tr>		
					</tbody>
				</table>
					...
					<tbody>
						...
						<tr>		       								
							<td>
	       					...
	       					<td colspan="5">
	       						${documento.paciente.lugarResidencia.calle}
	       					</td>
						</tr>
						...
						<tr>
							<td>
	       					...
	       					<td>
	       						${documento.paciente.lugarResidencia.estado}
	       					</td>
							...
							<td>
	       					...
	       					<td>
	       						${documento.paciente.lugarResidencia.municipio}
	       					</td>							       					
							<td>
	       						Parroquia
	       					</td>							       					
	       					<td>
	       						${documento.paciente.lugarResidencia.parroquia}
	       					</td>		
	       				</tr>		
					</tbody>
				</table>
	 			...
	 			<table>
	     			<tbody>
						<tr>
							...
							<td>
								${documento.institucionRefiere}
							</td>							
							<td>
								Medico que refiere											  
							</td>							
							<td>
								${documento.medicoRefiere}
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								${documento.pacienteUbicacion}
							</td>							
							<td>
								Distrito sanitario											  
							</td>							
							<td>
								${documento.distritoSanitario}
							</td>
						</tr>						
						<tr>
							<td>
							...
							<td>
								${documento.investigacionSolicitada}
							</td>							
							<td>
								Fecha de inicio de s&#237;ntomas											  
							</td>							
							<td>
								${fechaFormateador.format(documento.fechaIniSintomas)}
							</td>
						</tr>						
						<tr>
							<td>
							...
							<td>
								${fechaFormateador.format(documento.fechaAtencionMedica)}
							</td>							
							<td>
								Estado											  
							</td>							
	 ...
	 <#if documento.pruebasInvestigacionSol??>
		 <#if documento.pruebasInvestigacionSol?size != 0 >
			 <component>
			   	<section>
			     	<title>
			     		Investigaci&#243;n solicitada
			     	...
			     	<text>	     		
						<table>
							<tbody>
					            ...
					            <#list documento.pruebasInvestigacionSol as prueba>
					                <tr>							   	 
					                    <td>							                      
					                      ${prueba.nombre}
					                    </td>
					                    <td>							                      
					                      ${prueba.datosAdicionales}
					                    </td>	
					                </tr>					   								    		
					            </#list>
							</tbody>
	     	...
	     	<text>
	     		<table>
					<tbody>
						<tr>
							<td>
								Fecha viaje m&#225;s reciente
							</td>							
							<td>
								${fechaFormateador.format(documento.fechaViajeReciente)}
							</td>							
							<td>
								Especie de animal dom&#233;stico
							</td>							
							<td>
								${documento.especieAnimalDomestico}
							</td>
						</tr>
						<tr>
							<td>
						...
						<tr>
							...
							<td>
								<#if documento.consumoLecheCruda>
									S&#237;
								<#else>
									No
								</#if>
							...
							<td>
								<#if documento.consumoCarneCruda>
									S&#237;
								<#else>
									No
								</#if>
	 ...
	 <#if documento.vacunas??>
		 <#if documento.vacunas?size != 0 >
			 <component>
			   	<section>
			     	<title>
			     		Estado inmune
			     	...
			     	<text>
						<table>
							<tbody>
					            ...
					            <#list documento.vacunas as vacuna>
					                <tr>							   	 
					                    <td>							                      
					                      ${vacuna.nombre}
					                    </td>
					                    <td>							                      
					                      ${vacuna.dosisAplicada}
					                    </td>
					                    <td>							                      
					                      ${fechaFormateador.format(vacuna.fechaAplicacion)}
					                    </td>	
					                </tr>					   								    		
					            </#list>
							</tbody>
     ...
     <#if documento.sintomas??>
	     <#if documento.sintomas?size != 0 >
		     <component>
			   	<section>
			     	<title>
			     		Signos y s&#237;ntomas
			     	...
			     	<text>
						<table>
							<tbody>
					            ...
					            <#list documento.sintomas as sintoma>
					                <tr>						   	 
					                    <td>							                      
					                      ${sintoma.nombre}
					                    </td>
					                    <td>							                      
					                      ${fechaFormateador.format(sintoma.fecha)}
					                    </td>	
					                </tr>					   								    		
					            </#list>
							</tbody>
     ...
     <component>
	   	<section>
	     	...
	     	<text>
	     		<#if documento.pruebasLab??>
		     		<#if documento.pruebasLab?size != 0 >
			     		<table>
							<tbody>
								<tr>
									<th colspan="2">
					            ...
					            <#list documento.pruebasLab as prueba>
					                <tr>							   	 
					                    <td>							                      
					                      ${prueba.nombre}
					                    </td>
	     		...
	     		<#if documento.pruebasLCRLab??>
		     		<#if documento.pruebasLCRLab?size != 0 >
			     		<table>
							<tbody>
								<tr>
									<th colspan="2">
					            ...
					            <#list documento.pruebasLCRLab as pruebaLCR>
					                <tr>							   	 
					                    <td>							                      
					                      ${pruebaLCR.nombre}
					                    </td>
	     		...
	     		<#if documento.muestrasLab??>
		     		<#if documento.muestrasLab?size != 0 >
						<table>
							<tbody>
								<tr>
									<th colspan="2">
					            ...
					            <#list documento.muestrasLab as muestra>
					                <tr>							   	 
					                    <td>							                      
					                      ${muestra.nombre}
					                    </td>
					                    <td>							                      
					                      ${fechaFormateador.format(muestra.fechaToma)}
					                    </td>	
					                </tr>				   								    		
					            </#list>
							</tbody>
